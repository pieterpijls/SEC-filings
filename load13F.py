# -*- coding: utf-8 -*-
"""
Created on Wed Apr 15 20:18:37 2020

@author: ppijls
"""
# https://github.com/codeLovingYogi/Edgar_Scraper/blob/master/main.py
...
for cik in list(cik_codes): 
    try:
        cik = cik.replace('#','')
        path = 'C:/Users/ppijls/Documents/R/Projects/Trading systems/13F/13f/'+cik
        os.mkdir(path)
    except OSError:
...
for cik in list(cik_codes):
    cik = cik.replace('#','')
    print('Start scraping data from CIK code ' + cik)
    os.chdir('C:/Users/ppijls/Documents/R/Projects/Trading systems/13F/13f/'+cik)

    while len(cik) < 1:
        cik = input('Please enter a ticker: ')
...
class HoldingsScraper:
    ...
    def __init__(self, ticker):
        self.browser = webdriver.PhantomJS(executable_path='C:/phantomjs-2.1.1-windows/bin/phantomjs')
